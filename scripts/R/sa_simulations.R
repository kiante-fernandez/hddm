...
# system2(command = "ifort", args = c("-help"))
system2(command = "ifort", args = c("-O3", "fit_sa_speed_accuracy", "-qopenmp", "-qmkl"))
...
if (!file.exists(here::here("scripts", "R", "generated_sim_params.RData"))) {
  ...
  parameter_sets[[2]] <- c(0.08, 0.16, 0.3, 0.08, 0.05, 0.1, 0.4, 0.25, 0.1, 0.0)
  parameter_sets[[3]] <- c(0.08, 0.16, 0.3, 0.16, 0.00, 0.1, 0.4, 0.25, 0.1, 0.0)
  parameter_sets[[4]] <- c(0.08, 0.16, 0.3, 0.16, 0.05, 0.1, 0.4, 0.25, 0.1, 0.0)
  parameter_sets[[5]] <- c(0.08, 0.16, 0.3, 0.08, 0.15, 0.1, 0.4, 0.25, 0.1, 0.0)
  parameter_sets[[6]] <- c(0.08, 0.16, 0.3, 0.16, 0.15, 0.1, 0.4, 0.25, 0.1, 0.0)
  parameter_sets[[7]] <- c(0.08, 0.16, 0.3, 0.08, 0.00, 0.1, 0.5, 0.40, 0.2, 0.1)
  parameter_sets[[8]] <- c(0.08, 0.16, 0.3, 0.08, 0.05, 0.1, 0.5, 0.40, 0.2, 0.1)
  parameter_sets[[9]] <- c(0.08, 0.16, 0.3, 0.08, 0.15, 0.1, 0.5, 0.40, 0.2, 0.1)
  parameter_sets[[10]] <- c(0.08, 0.16, 0.3, 0.16, 0.00, 0.1, 0.5, 0.40, 0.2, 0.1)
  parameter_sets[[11]] <- c(0.08, 0.16, 0.3, 0.16, 0.05, 0.1, 0.5, 0.40, 0.2, 0.1)
  parameter_sets[[12]] <- c(0.08, 0.16, 0.3, 0.16, 0.15, 0.1, 0.5, 0.40, 0.2, 0.1)
