...
c      include '/opt/intel/Compiler/11.1/064/mkl/include/mkl_vsl.fi'
      ...
      double precision rt(100),yi(100),cond(100),gu(80000),y(39)
      integer mch(100),mcond(100),con(100)
...
C files
      write(14,*)n,(mcond(i),i=1,n)
C     write(*,*)n,(mcond(i),i=1,n)
      write(15,*)n,(rt(i),i=1,n)
C     write(*,*)n,(rt(i),i=1,n)
      write(16,*)n,(mch(i),i=1,n)
C     write(*,*)(i,mcond(i),mch(i),rt(i),i=1,n)
      rewind(14)
      rewind(15)
      rewind(16)
c boundary
...
c po (contam)
      x(7)= .0001
C drift rates (two drift rates for each condition)
      x(8)= .32
      x(9)= .1
...
C     WRITE(4,47)(X(I),I=1,NV)
   47 FORMAT(f7.4,9F8.4)
    7 CONTINUE
      ...
      implicit double precision (a-h,o-z)
      double precision X(NV),r(9),y(9),rs(9)
      double precision rt(100),yi(100),xml(100)
      integer mch(100),mcond(100),con(100)
      nn=100
...
c      do 2 j=1,4
c      read(3,*)n1
c      read(3,*)(rt(i+kk),i=1,n1-1)
C     print*,rt(1+kk),rt(n1-1+kk),n1-1
c      read(4,*)n2
c      read(4,*)(rt(i+kk),i=n1,n1+n2-2)
C     print*,j,kk,n1,n2
c      do 4 jk=kk+1,kk+n1-1
c      mcond(jk)=j
c      mch(jk)=1
c    4 continue
c      do 5 jk=kk+n1,kk+n1+n2-2
c      mcond(jk)=j
c      mch(jk)=2
c    5 continue
c      kk=kk+n1+n2-2
...
c Blair turned this back on
      read(14,*)n,(mcond(i),i=1,nn)
      read(15,*)n,(rt(i),i=1,nn)
      read(16,*)n,(mch(i),i=1,nn)
C     write(*,"(3i6,f9.3)")(i,mcond(i),mch(i),rt(i),i=1,nn)
      rewind(14)
      rewind(15)
      rewind(16)
      pxa=0.
