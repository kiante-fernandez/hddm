...
C      if(aa.eq."speed1")mcond(i)=1
C      if(aa.eq."speed2")mcond(i)=2
C      if(aa.eq."speed3")mcond(i)=3
C      if(aa.eq."speed4")mcond(i)=4

      if(aa.eq."accuracy1")mcond(i)=1
      if(aa.eq."accuracy2")mcond(i)=2
      if(aa.eq."accuracy3")mcond(i)=3
      if(aa.eq."accuracy4")mcond(i)=4
